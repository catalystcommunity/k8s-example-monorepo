...
(
    session_id uuid      default generate_ulid() not null primary key,
...
(
    ...
    thing_type_id    uuid      default generate_ulid() not null primary key,
    created_at       timestamp default timezone('utc', now()) not null,
    updated_at       timestamp default timezone('utc', now()) not null,
    name             text not null,
...
(
    owned_thing_id   uuid      default generate_ulid() not null primary key,
    created_at       timestamp default timezone('utc', now()) not null,
    updated_at       timestamp default timezone('utc', now()) not null,
    name             text,
    thing_type_id    uuid not null references thing_types on delete cascade,
...
(
    borrow_id        uuid      default generate_ulid() not null primary key,
    created_at       timestamp default timezone('utc', now()) not null,
    updated_at       timestamp default timezone('utc', now()) not null,
    borrower_id      uuid not null references users,
    owned_thing_id   uuid not null references owned_things,
